...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in data_feed_pb2_grpc.py depends on'
...
def add_DataFeedServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'DataFeed', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('DataFeed', rpc_method_handlers)
